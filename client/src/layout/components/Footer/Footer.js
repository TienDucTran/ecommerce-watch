    ...
    <footer>
      ...
      (
        ...
        <div className={cx("name")}>
          {" "}
          {i18n.language === "vn" ? (
            <span>Watchshop ĐỒNG HỒ VÀ TRANG SỨC</span>
          ) : (
            <span>Watchshop WATCH AND JEWELRY</span>
          )}
        </div>
          ...
          <div className={cx("bottom")}>
            ...
            <div className={cx("contact")}>
              ...
              <div className={cx("location")}>
                <MdLocationOn /> A12, Quang Trung, Q. Gò Vấp, TP. Hồ Chí Minh
              </div>
      ...
      <div className={cx("copy")}>
        © Copyright 2022-2023 Watchshop. Design ByME
      </div>
    </footer>
  );
};
