...
import { handleCancel, handlePayment } from "./sharedFunctions";
        ...
        {orderProduct.map((product) => (
          <div className={cx("product")} key={product._id}>
            ...
            {product.status === "transport" ? (
              ...
              onClick={() => handleCancel(product._id, product, userInfo._id, dispatch)}
              >
                {i18n.language === "vn" ? (
                  <span>Hủy đơn</span>
                ) : (
              ...
              onClick={() => handlePayment(product._id, product,userInfo._id, dispatch)}
              >
                {i18n.language === "vn" ? (
